  ...
  <div className={styles.container}>
    <div className={styles.modal}>
      ...
      <div className={styles.photo}>
        <input className={styles.photo__input} type="file" accept="image/*" multiple="" />
        <img src={uploadPhoto} alt="upload" />
        <p className={styles.photo__description}>select an image file to upload or drag it here</p>
      </div>
